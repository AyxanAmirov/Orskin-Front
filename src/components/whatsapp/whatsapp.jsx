...
function Whatsapp() {
  return (
    <a
      href="https://wa.me/971504459672"
      target="_blank"
      rel="noopener noreferrer"
    >
      <div className="z-[14] cursor-pointer xl:rounded-[20px] lg:rounded-[20px] md:rounded-[20px] rounded-[50%] fixed right-7 bottom-[20px] bg-[#22DDB0] xl:px-[9px] lg:px-[9px] md:px-[9px] xl:py-[4px] lg:py-[4px] md:py-[4px] flex items-center gap-[10px] xl:w-auto lg:w-auto md:w-auto w-[40px] ">
