          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-[20px] justify-between items-center">
            <div className="flex gap-[20px] xl:justify-normal lg:justify-normal md:justify-center sm:justify-center justify-center">
              <Tooltip label="Facebook">
                ...
                >
                  <div
                    className="py-[5px] px-[13px] text-[14px] bg-white rounded-[5px] hover:bg-[#F0F5F4] transition duration-[500]"
                    data-aos="zoom-in"
                  >
                    <FontAwesomeIcon icon={faFacebookF} className="text-[#B3D6D0]" />
                  </div>
                </a>
              </Tooltip>
              ...
              <Tooltip label="Instagram">
                ...
                >
                  <div
                    ...
                    data-aos="zoom-in"
                  >
                    <FontAwesomeIcon icon={faInstagram} className="text-[#B3D6D0]" />
                  </div>
                </a>
              </Tooltip>
