...
export const services = [
  ...
  },
  {
    ...
    moreinfo: {
      ...
      image: null,
      description: "Even with a healthy lifestyle, it can be challenging to reduce localized fat in certain areas — especially with age. At Orskin, we offer a range of non-surgical body contouring treatments tailored to support your aesthetic goals.",
      items: [
        {
          id: 1,
          image: Endospheres,
  ...
  },
  {
    ...
    moreinfo: {
      ...
      image: null,
      description: "At Orskin, we prioritise patient confidence and individualised care. Our non-surgical skincare treatments are customised based on each patient’s unique needs and expectations. The Aesthetics Department is supervised by Medical Director Dr. Asima Nasir — a board-certified physician with international experience, dedicated to applying evidence-based methods to support natural-looking results.",
      items: [
        {
          id: 1,
          image: Botox,
    ...
    moreinfo: {
      ...
      items: [
        ...
        },
        {
          ...
          description: `<p class="mb-[10px]">If your complexion feels congested and your skin is looking dull, it’s time to indulge in the Orskin Signature Deep Cleansing Facial — a fully customized, results-driven experience designed to reset and revive your skin.</p>
          <p class="mb-[10px]">Unlike traditional facials, Orskin’s protocols are never one-size-fits-all. We tailor every step to your unique skin needs using advanced technology, expert techniques, and our exclusive treatment rituals. This luxurious facial includes:</p>

<ul>
  <li>✨ A thorough double cleanse to purify and prepare the skin</li>
  <li>✨ Gentle steaming and customized extractions (if needed) to clear blackheads and buildup</li>
  <li>✨ Our Signature Orskin Massage Protocol to boost circulation, sculpt, and relax</li>
  <li>✨ A carefully selected mask and high-performance serums based on your skin type</li>
  <li>✨ A nourishing moisturizer to lock in hydration</li>
  <li>✨ And the highlight — Full-Body LED Light Therapy, designed to enhance skin clarity, reduce inflammation, and promote cellular rejuvenation from head to toe</li>
</ul>
<p class="mb-[10px]">This treatment not only delivers a deep cleanse but also offers a total skin transformation — helping to balance oil production, calm breakouts, and bring back a healthy, radiant glow.</p>
<p>Orskin facials are more than treatments — they are a ritual, a reset, and a powerful step toward your most beautiful skin yet.</p>
...
`
        ...
        },
        {
          ...
          description: "Diathermy cell therapy involves the use of high-frequency electromagnetic currents to generate therapeutic heat within body tissues. It is commonly applied in supportive physical therapy settings, aiming to aid tissue function and comfort. The procedure may support improved local circulation and lymphatic flow, which can contribute to overall skin wellness. When used as part of a non-invasive skin programme, it may promote cellular activity, including collagen and elastin stimulation. Diathermy is also considered beneficial in post-operative care to support tissue recovery and flexibility."
        },
        {
          id: 24,
          image: null,
          title: "Thermolysis",
          description: "Thermolysis is a widely used method in advanced aesthetic practice for the targeted reduction of unwanted hair. The technique involves delivering precise thermal energy through an ultra-fine probe inserted into the hair follicle, reaching the root level. This controlled process affects the germinal cells responsible for hair growth, helping to gradually minimise regrowth over time. Thermolysis is particularly considered a suitable option for treating thick or persistent hair in delicate or resistant areas."
        },
        {
          id: 25,
          image: null,
        ...
        },
        {
          ...
          image: Volnewmer,
          title: "Volnermer",
          description: `<h2 class="text-[22px] font-[800] mb-[15px]">VOLNEWMER: Advanced Skin Tightening & Remodeling Technology</h2>
<p>Powered by Monopolar Radiofrequency + Hidden Edge Technology</p>

<p>At Orskin Aesthetics, we bring you VOLNEWMER, a next-generation radiofrequency treatment designed to rejuvenate and tighten the skin from deep within — safely, effectively, and with minimal discomfort.</p>

<h4 class="text-[18px] font-[700] my-[10px]">Why VOLNEWMER is Unique</h4>

<p>Hidden Edge Technology: This patented innovation allows energy to penetrate deeper beneath the skin’s surface while keeping the outer layer protected, ensuring effective subdermal heating with reduced discomfort.</p>
<p>Deep Volumetric Heating: Reaches both the dermis and subcutaneous layers, stimulating natural collagen production and skin firming from the inside out.</p>
<p>Superior Depth Penetration: Unlike traditional bipolar RF, monopolar RF treats deeper layers, making it ideal for areas with loose skin or thicker fat deposits, especially on the body.</p>

<h4 class="text-[16px] font-[700] my-[10px]">What It Treats</h4>
<ul>
          <li class="list-disc list-inside">Deep skin tightening and lifting for both face and body</li>
          <li class="list-disc list-inside">Improved skin texture, elasticity, and firmness</li>
          <li class="list-disc list-inside">Long-term collagen regeneration and skin remodeling
Whether you’re seeking to restore firmness after weight loss, smooth out skin laxity, or achieve a lifted, rejuvenated look without surgery, VOLNEWMER offers powerful, non-invasive results through precise heat delivery.</li>
</ul>
...
`
        },
        {
          ...
          image: Ultraformer,
          title: "Ultraformer",
          description: `<h2 class="text-[22px] font-[800] mb-[15px]">Ultraformer MPT: The Next Generation of Non-Invasive Lifting & Contouring</h2>
<p>Powered by Advanced MMFU (Micro & Macro Focused Ultrasound) + Micro Pulsed Technology</p>

<p>At Orskin Aesthetics, we are proud to offer Ultraformer MPT, the most advanced evolution in ultrasound-based skin rejuvenation. This cutting-edge technology redefines non-invasive lifting and contouring with exceptional precision, comfort, and results.</p>

<h4 class="text-[18px] font-[700] my-[10px]">Why Ultraformer MPT Stands Out</h4>

<p>Micro Pulsed Technology (MPT): Delivers energy in smaller, more refined bursts, allowing for tailored treatments that are both gentle and highly effective.</p>
<p>Deep Synergy Effects: Simultaneously targets volumization, skin tightening, and collagen production – all in one session.</p>
<p>Faster Sessions, Less Discomfort: Designed for quicker treatments and minimal discomfort, making it a more comfortable alternative to traditional HIFU devices.</p>
<p><p>Faster Sessions, Less Discomfort: Designed for quicker treatments and minimal discomfort, making it a more comfortable alternative to traditional HIFU devices.</p></p>

<h4 class="text-[16px] font-[700] my-[10px]">What It Treats</h4>
<ul>
          <li class="list-disc list-inside">Mid-face and jawline contouring</li>
          <li class="list-disc list-inside">Double chin and stubborn fat pockets</li>
          <li class="list-disc list-inside">Skin tightening and lifting with minimal to no downtime</li>
          <li class="list-disc list-inside">Deep skin rejuvenation and collagen stimulation</li>
          <li class="list-disc list-inside">Fine lines and wrinkles</li>
          <li class="list-disc list-inside">Whether you're looking to sculpt your jawline, lift sagging skin, or achieve an overall youthful glow, Ultraformer MPT offers visible, natural-looking results without surgery or downtime.</li>
</ul>
...
`
  ...
  },
  {
    ...
    moreinfo: {
      ...
      description: "At Orskin, our focus extends beyond outer beauty — we aim to support your overall sense of wellbeing. Alongside our skincare and aesthetic services, our Wellness Department provides supportive treatments designed to promote internal balance. Our IV therapy options are tailored to individual needs and may include vitamin infusions, hydration support, or wellness-focused drips. Popular choices such as NAD+ or antioxidant blends are offered to complement your body's natural recovery and cellular function.",
      items: [
        {
          id: 1,
          image: null,
...
export const feedbacks = [
  {
    id: 1,
    "desc": "I had amazing experience in Orskin clinic , all the therapists I have met there are professional, organized, and polite. The Clinic is clean, beautiful and homey… \n The owner(Orsi) is one of good people I met in my life. I am in love with their services.Absolutely recommend them for their services.",
    "author": "Parastoo Safdari"
  },
  {
    id: 2,
    "desc": "Place to treat you skin all staff are friendly I have been treating my skin with them for almost two Years and I have been always satisfied with the results they also have  skin care products which i am always using environ and dmk products have improved my skin texture and help to control my acne",
    "author": "Lama Ibrahim"
  },
  {
    id: 3,
  ...
  {
    id: 5,
    "desc": "I had an excellent facial treatment at Orskin clinic with the therapist Mme Barbarie, she is very professional and gave me advises for my skin. They are using very professional products and good quality. The ambiance and the staff are very pleasant, I definitely recommend this Clinc for any skin type treatment.",
  ...
  {
    id: 7,
    "desc": "Orskin Clinic in Dubai offers a professional and welcoming environment. The founder, Orsi, leads the clinic with dedication and expertise. The clinic maintains high standards of cleanliness and provides a variety of up-to-date aesthetic treatments. Many clients appreciate the personalised care and comfortable atmosphere offered here.",
    "author": "Lilla Reti"
  },
  {
    id: 8,
    "desc": "I have had positive experiences with facial treatments at this clinic. Therapist Allysia is skilled and attentive, providing personalised care plans based on individual skin types. The clinic utilises modern equipment and techniques to support skin health. I appreciate their professional approach and recommend their services for customised facial care.",
    "author": "Neethu Anzer"
  },
  {
    id: 9,
...
export const team = [
  {
    ...
    description: "Introducing our Co-Founder, Orsolya Matheisz (known as Orsi), a licensed aesthetician from Hungary with over 18 years of professional experience in beauty, facial care, and anti-aging treatments. Driven by a passion for beauty and wellness, Orsi founded the company to offer advanced skincare technologies paired with a balanced approach that combines both sophistication and accessibility.",
  ...
  {
    id: 4,
    fullName: "Dr Shehzadi Tasneem",
    position: "Plastic Surgeon",
    alt: "Dr. Shehzadi Tasneem",
    description: "Dr. Shehzadi Tasneem Sultan is one of Dubai’s leading female plastic surgeons, renowned for her exceptional skill in body contouring and facial rejuvenation. With years of experience and a meticulous eye for detail, she delivers results that are both natural and transformative. Dr. Shehzadi offers a comprehensive range of cosmetic procedures designed to help you achieve your unique aesthetic goals. If you’re looking for a trusted and highly accomplished female plastic surgeon in Dubai, Dr. Shehzadi is the perfect choice.",
    image: "https://placehold.co/480x600?text=Dr+Shehzadi+Tasneem&font=Raleway"
  }
]
...
export const blogs = [
  {
    ...
    description: `
            ...
            <br>
            <p data-aos="zoom-in" >A recommended homecare product to complement treatments such as Plasma Gel or PRF is Adipeau Cream.</p>
            ...
            <p data-aos="zoom-in" >For optimal care, apply Adipeau Cream twice daily—morning and evening—on clean, dry skin. Use gentle upward strokes to massage the cream into your face and neck for even coverage. Regular application may support the effects of plasma gel bio filler and contribute to overall skin health.</p>
            <br/>
  ...
  },
  {
    ...
    cover: blog2cover,
    coverMin: blog2cover,
    introduction: "Winter is an ideal season in Dubai, offering cooler temperatures and lower humidity. It also marks the perfect time to consider chemical peel treatments to refresh and rejuvenate your skin.",
    description: `<h2 data-aos="zoom-in"  class="text-[20px] mb-[16px]"> <strong>Winter is an ideal season in Dubai, offering cooler temperatures and lower humidity. It also marks the perfect time to consider chemical peel treatments to refresh and rejuvenate your skin.</strong></h2>
       ...
       <h3 data-aos="zoom-in"  class="text-[18px] mb-[6px]"><strong>We focus on results</strong></h3>
        <p data-aos="zoom-in" >With appropriate care and personalized treatments designed to meet your individual needs, you can support your skin’s natural health and appearance.</p>
...
<br/>
        ...
        <p data-aos="zoom-in">Before undergoing laser treatments such as UltraClear or AdvaLight, proper skin preparation is important to support the healing process. At Orskin, we suggest considering Platelet-Rich Fibrin (PRF) or Salmon DNA therapy as part of your pre-treatment care. These treatments aim to enhance skin condition and create a suitable foundation for laser procedures..</p>
        <br/>
...
`,
  ...
  },
  {
    ...
    introduction: "The Science Behind Combination Treatments at Orskin Aesthetics integrates advanced and safe techniques with personalized facial care designed to meet individual needs.",
    description: `
        <p class="mb-[10px]">The Science Behind Combination Treatments at Orskin Aesthetics integrates advanced and safe techniques with personalized facial care designed to meet individual needs.</p>
  ...
  },
  {
    ...
    description: `
          ...
          <div style="margin-top: 60px; text-align: center;" data-aos="zoom-in-up">
              ...
              <p data-aos="fade-up"><strong>Only at <a 
              href="https://orskin.ae"
              target="_blank"
...
export const seoContent = {
  home: {
    id: 1,
    title: "Orskin – Dubai-Based Aesthetic Clinic | Skincare & Treatments",
      ...
      "@graph": [
        {
          ...
          "image": [
            "https://orskin.ae/assets/images/logo.webp",
            "https://orskin.ae/assets/images/home-banner1.webp",
            "https://orskin.ae/assets/images/home-banner2.webp",
            "https://orskin.ae/assets/images/home-banner3.webp",
            "https://orskin.ae/assets/images/service3.webp",
            "https://orskin.ae/assets/images/service2.webp",
            "https://orskin.ae/assets/images/service1.webp",
            "https://orskin.ae/assets/images/dmg-logo.webp",
  ...
  about: {
    id: 2,
    title: "Qualified Aesthetic Doctors in Dubai | Experienced Professionals in Aesthetic Care",
      ...
      "@graph": [
        {
          ...
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [
            "https://orskin.ae/assets/images/aboutus-banner.webp",
      ...
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/services",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [
            "https://orskin.ae/assets/images/service-banner-laser.webp",
            "https://orskin.ae/assets/images/service-banner-slimming.webp",
            "https://orskin.ae/assets/images/service-banner-aesthetics.webp",
            "https://orskin.ae/assets/images/service-banner-facials.webp",
            "https://orskin.ae/assets/images/service-banner-wellness.webp",
            "https://orskin.ae/assets/images/service1.webp",
            "https://orskin.ae/assets/images/service2.webp",
            "https://orskin.ae/assets/images/service3.webp",
            "https://orskin.ae/assets/images/service4.webp",
            "https://orskin.ae/assets/images/service5.webp",
            "https://orskin.ae/assets/images/service6.webp"
          ],
          "description": "At Orskin Aesthetics in Dubai, we offer a variety of exceptional beauty and wellness services tailored to your needs. From rejuvenating wellness treatments, advanced laser therapies, and signature facials to slimming procedures, aesthetic injectables, fat burning treatments.",
          "address": {
            "@type": "PostalAddress",
        ...
        "@graph": [
          {
            ...
            "@type": "MedicalClinic",
            "name": "Orskin Aesthetic Clinic",
            "url": "https://orskin.ae/blog",
            "logo": "https://orskin.ae/assets/images/logo.webp",
            "image": [
              "https://orskin.ae/assets/images/blog5min.webp",
  ...
  laser: {
    ...
    description: "At Orskin Aesthetics in Dubai, we offer a variety of exceptional beauty and wellness services tailored to your needs. From rejuvenating wellness treatments, advanced laser therapies, and signature facials to slimming procedures, aesthetic injectables, fat burning treatments.",
    keywords: "",
    canonical: "https://orskin.ae/services/laser",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/services/laser",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Laser",
              "item": "https://orskin.ae/services/laser"
            }
          ]
        }
      ]
  ...
  slimming: {
    ...
    description: "At Orskin Aesthetics in Dubai, we offer a variety of exceptional beauty and wellness services tailored to your needs. From rejuvenating wellness treatments, advanced laser therapies, and signature facials to slimming procedures, aesthetic injectables, fat burning treatments.",
    keywords: "",
    canonical: "https://orskin.ae/services/slimming",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/services/slimming",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [
            "https://orskin.ae/assets/images/Slimming_Banner.webp",
            "https://orskin.ae/assets/images/Endospheres-400x320.webp",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Slimming",
              "item": "https://orskin.ae/services/slimming"
            }
          ]
        }
      ]
  ...
  aesthetics: {
    ...
    description: "At Orskin Aesthetics in Dubai, we offer a variety of exceptional beauty and wellness services tailored to your needs. From rejuvenating wellness treatments, advanced laser therapies, and signature facials to slimming procedures, aesthetic injectables, fat burning treatments.",
    keywords: "",
    canonical: "https://orskin.ae/services/aesthetics",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/services/aesthetics",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [
            "https://orskin.ae/assets/images/AestheFill.webp",
            "https://orskin.ae/assets/images/Regenera-400x320.webp",
            "https://orskin.ae/assets/images/Exosomes-400x320.webp",
            "https://orskin.ae/assets/images/Sculptra-400x320.webp",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Aesthetics",
              "item": "https://orskin.ae/services/aesthetics"
            }
          ]
        }
      ]
  ...
  facials: {
    ...
    description: "At Orskin Aesthetics in Dubai, we offer a variety of exceptional beauty and wellness services tailored to your needs. From rejuvenating wellness treatments, advanced laser therapies, and signature facials to slimming procedures, aesthetic injectables, fat burning treatments.",
    keywords: "",
    canonical: "https://orskin.ae/services/facials",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/services/facials",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [
            "https://orskin.ae/assets/images/facials-banner.webp",
            "https://orskin.ae/assets/images/Holistic-Facial-400x320.webp",
            "https://orskin.ae/assets/images/Deep-Cleansing-400x320.webp",
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Facials",
              "item": "https://orskin.ae/services/facials"
            }
          ]
        }
      ]
  ...
  wellness: {
    ...
    description: "At Orskin Aesthetics in Dubai, we offer a variety of exceptional beauty and wellness services tailored to your needs. From rejuvenating wellness treatments, advanced laser therapies, and signature facials to slimming procedures, aesthetic injectables, fat burning treatments.",
    keywords: "",
    canonical: "https://orskin.ae/services/wellness",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/services/wellness",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Wellness",
              "item": "https://orskin.ae/services/wellness"
            }
          ]
        }
      ]
  ...
  latest: {
    ...
    description: "At Orskin Aesthetics in Dubai, we offer a variety of exceptional beauty and wellness services tailored to your needs. From rejuvenating wellness treatments, advanced laser therapies, and signature facials to slimming procedures, aesthetic injectables, fat burning treatments.",
    keywords: "",
    canonical: "https://orskin.ae/services/latest",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/services/latest",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 3,
              "name": "Latest",
              "item": "https://orskin.ae/services/latest"
            }
          ]
        }
      ]
  ...
  "stem-cell-therapy-blog": {
    ...
    description: "Discover expert insights, beauty tips, skin care treatments, and wellness advice on the Orskin Aesthetic Clinic blog. Find the latest trends in aesthetic procedures, wellness routines, and skin rejuvenation in Dubai.",
    keywords: "",
    canonical: "https://orskin.ae/blog/stem-cell-therapy-blog",
    schema: `{
        "@context": "https://schema.org",
        "@graph": [
          {
            ...
            "@type": "MedicalClinic",
            "name": "Orskin Aesthetic Clinic",
            "url": "https://orskin.ae/blog/stem-cell-therapy-blog",
            "logo": "https://orskin.ae/assets/images/logo.webp",
            "image": [
              "https://orskin.ae/assets/images/blog5cover.webp",
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://orskin.ae/blog/stem-cell-therapy-blog"
              }
            ]
          }
        ]
  ...
  "unlocking-radiant-skin-with-orkin’s-combinations": {
    id: 13,
    title: "Unlocking radiant skin with orkin's combinations",
    description: "Discover expert insights, beauty tips, skin care treatments, and wellness advice on the Orskin Aesthetic Clinic blog. Find the latest trends in aesthetic procedures, wellness routines, and skin rejuvenation in Dubai.",
    keywords: "",
    canonical: "https://orskin.ae/blog/unlocking-radiant-skin-with-orkin%E2%80%99s-combinations",
    schema: `{
        "@context": "https://schema.org",
        "@graph": [
          {
            ...
            "@type": "MedicalClinic",
            "name": "Orskin Aesthetic Clinic",
            "url": "https://orskin.ae/blog/unlocking-radiant-skin-with-orkin%E2%80%99s-combinations",
            "logo": "https://orskin.ae/assets/images/logo.webp",
            "image": [
              "https://orskin.ae/assets/images/blog4cover.webp"
            ],
            "description": "Discover expert insights, beauty tips, skin care treatments, and wellness advice on the Orskin Aesthetic Clinic blog. Find the latest trends in aesthetic procedures, wellness routines, and skin rejuvenation in Dubai.",
            "address": {
              "@type": "PostalAddress",
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": "Unlocking Radiant Skin with Orkin’s Combinations",
                "item": "https://orskin.ae/blog/unlocking-radiant-skin-with-orkin%E2%80%99s-combinations"
              }
            ]
          }
        ]
  ...
  "fall-is-the-perfect-time-for-laser-treatments": {
    id: 14,
    title: "Fall is the perfect time for laser treatments",
    description: "Discover expert insights, beauty tips, skin care treatments, and wellness advice on the Orskin Aesthetic Clinic blog. Find the latest trends in aesthetic procedures, wellness routines, and skin rejuvenation in Dubai.",
    keywords: "",
    canonical: "https://orskin.ae/blog/fall-is-the-perfect-time-for-laser-treatments",
    schema: `{
        "@context": "https://schema.org",
        "@graph": [
          {
            ...
            "@type": "MedicalClinic",
            "name": "Orskin Aesthetic Clinic",
            "url": "https://orskin.ae/blog/fall-is-the-perfect-time-for-laser-treatments",
            "logo": "https://orskin.ae/assets/images/logo.webp",
            "image": [
              "https://orskin.ae/assets/images/blog3cover1140x408.webp",
              "https://shop.orskin.ae/cdn/shop/files/ASCE_-Exobalm-2.png",
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": "Fall is the perfect time for laser treatments",
                "item": "https://orskin.ae/blog/fall-is-the-perfect-time-for-laser-treatments"
              }
            ]
          }
        ]
  ...
  "winter-skin-renewal-means-peel-season-is-here": {
    id: 15,
    title: "Winter skin renewal means peel season is here",
    description: "Discover expert insights, beauty tips, skin care treatments, and wellness advice on the Orskin Aesthetic Clinic blog. Find the latest trends in aesthetic procedures, wellness routines, and skin rejuvenation in Dubai.",
    keywords: "",
    canonical: "https://orskin.ae/blog/winter-skin-renewal-means-peel-season-is-here",
    schema: `{
        "@context": "https://schema.org",
        "@graph": [
          {
            ...
            "@type": "MedicalClinic",
            "name": "Orskin Aesthetic Clinic",
            "url": "https://orskin.ae/blog/winter-skin-renewal-means-peel-season-is-here",
            "logo": "https://orskin.ae/assets/images/logo.webp",
            "image": [
              "https://orskin.ae/assets/images/blog2-cover-1200x429.webp",
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": "Winter skin renewal means peel season is here",
                "item": "https://orskin.ae/blog/winter-skin-renewal-means-peel-season-is-here"
              }
            ]
          }
        ]
  ...
  "platelet-rich-fibrin-(prf)-plasmagel": {
    id: 16,
    title: "Platelet rich fibrin (prf) plasmagel",
    description: "Discover expert insights, beauty tips, skin care treatments, and wellness advice on the Orskin Aesthetic Clinic blog. Find the latest trends in aesthetic procedures, wellness routines, and skin rejuvenation in Dubai.",
    keywords: "",
    canonical: "https://orskin.ae/blog/platelet-rich-fibrin-(prf)-plasmagel",
    schema: `{
        "@context": "https://schema.org",
        "@graph": [
          {
            ...
            "@type": "MedicalClinic",
            "name": "Orskin Aesthetic Clinic",
            "url": "https://orskin.ae/blog/platelet-rich-fibrin-(prf)-plasmagel",
            "logo": "https://orskin.ae/assets/images/logo.webp",
            "image": [
              "https://orskin.ae/assets/images/blog1-1140px408.webp",
              "https://shop.orskin.ae/cdn/shop/files/adipeau-active1.jpg"
            ],
            "description": "Discover expert insights, beauty tips, skin care treatments, and wellness advice on the Orskin Aesthetic Clinic blog. Find the latest trends in aesthetic procedures, wellness routines, and skin rejuvenation in Dubai.",
            "address": {
              "@type": "PostalAddress",
          ...
          },
          {
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": "Platelet rich fibrin (prf) plasmagel",
                "item": "https://orskin.ae/blog/platelet-rich-fibrin-(prf)-plasmagel"
              }
            ]
          }
        ]
  ...
  termsandpolicy: {
    ...
    description: "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
    keywords: "",
    canonical: "https://orskin.ae/terms-and-policy",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/terms-and-policy",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [],
          "description": "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and the latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
          "address": {
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "item": "https://orskin.ae/terms-and-policy"
            }
          ]
        }
      ]
  ...
  termofuse: {
    ...
    description: "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
    keywords: "",
    canonical: "https://orskin.ae/term-of-use",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/term-of-use",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [],
          "description": "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and the latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
          "address": {
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Term of use",
              "item": "https://orskin.ae/term-of-use"
            }
          ]
        }
      ]
  ...
  termssupply: {
    ...
    description: "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
    keywords: "",
    canonical: "https://orskin.ae/terms-supply",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/terms-supply",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [],
          "description": "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and the latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
          "address": {
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Terms supply",
              "item": "https://orskin.ae/terms-supply"
            }
          ]
        }
      ]
  ...
  privacypolicy: {
    ...
    description: "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
    keywords: "",
    canonical: "https://orskin.ae/privacy-policy",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/privacy-policy",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [],
          "description": "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and the latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
          "address": {
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Privacy Policy",
              "item": "https://orskin.ae/privacy-policy"
            }
          ]
        }
      ]
  ...
  cookiepolicy: {
    ...
    description: "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
    keywords: "",
    canonical: "https://orskin.ae/cookie-policy",
    schema: `{
      "@context": "https://schema.org",
      "@graph": [
        {
          ...
          "@type": "MedicalClinic",
          "name": "Orskin Aesthetic Clinic",
          "url": "https://orskin.ae/cookie-policy",
          "logo": "https://orskin.ae/assets/images/logo.webp",
          "image": [],
          "description": "Orskin Aesthetic Clinic in Dubai offers slimming, wellness, signature facials, and the latest laser treatments. Focusing on personalized care and top-quality skincare, Orskin delivers transformative results in a luxurious setting, making your beauty goals a priority.",
          "address": {
        ...
        },
        {
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 2,
              "name": "Cookie policy",
              "item": "https://orskin.ae/cookie-policy"
            }
          ]
        }
      ]
