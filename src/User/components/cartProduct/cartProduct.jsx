...
function CartProduct() {
  return (
    <tr className="border-t-[1px] border-[#E2E2E2] border-solid  xl:table-row lg:table-row flex flex-col items-center gap-[40px]">
      <td className=" flex xl:flex-row lg:flex-row flex-col gap-[20px] items-center py-[30px] px-[20px]">
        <img
      ...
      <td className="text-[#A5A7AA] text-[14px] ">AED 391.00</td>
      <td className="text-[#9AD6CC] cursor-pointer pr-[15px]">X</td>
    </tr>
  );
}
