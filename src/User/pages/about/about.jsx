...
import TeamBottomBanner from "../../assets/images/team.jpg";
  ...
  return (
    <>
      <div className="flex justify-center">
        <img src={aboutInfo.banner} alt="Orskin About Info banner" className="w-100 xl:h-[420px] lg:h-[390px] md:h-[330px] sm:h-[310px] h-[200px]" />
      </div>
